...
class ExamTestPage extends Component {
                ...
                <FuseAnimate animation="transition.expandIn" delay={300}>
                    <div className="flex flex-row justify-between">
                        <div className="flex flex-row inline-block">
                            ...
                            <div className="textField color_blue items-center flex flex-row">
                                <Icon className="color_grey text-xs mr-12">
                                    calendar_today
        </Icon>
                                <MuiPickersUtilsProvider className="color_blue" utils={DateFnsUtils}>
                                    <DatePicker
                                        className="color_blue inline-block"
                                        value={selectedDate}
                                        format="dd/MM/yyyy"
