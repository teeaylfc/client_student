...
import StudentRegisterTab from './tabs/StudentRegisterTab';
        ...
        return (
            <div className={classNames(classes.root, "flex flex-col flex-1 flex-no-shrink p-24 md:flex-row md:p-0")}>
                ...
                <FuseAnimate animation={{translateX: [0, '100%']}}>
                    ...
                    <Card className="w-full max-w-600 mx-auto m-16 md:m-0" square>
                        ...
                        <CardContent className="flex flex-col items-center justify-center p-32 md:p-48 md:pt-128 ">
                            ...
                            {tabValue === 0 && <StudentRegisterTab/>}
                            {tabValue === 1 && <TeacherRegisterTab/>}

                            <div className="flex flex-col items-center justify-center pt-32 pb-24">
                                <span className="font-medium">Already have an account?</span>
                                <Link className="font-medium" onClick={this.goBack}>Login</Link>
