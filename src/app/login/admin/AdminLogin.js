...
import AdminTLoginTab from './tabs/AdminTLoginTab';
                    ...
                    <FuseAnimate animation={{translateX: [0, '100%']}}>
                        <Card className="w-full max-w-500 login-page" square>
                            <CardContent className="flex flex-col items-center justify-center login-box">
                                <Avatar alt="User" src="assets/images/login/avt_login_admin.png" className="avatar-custom" />
                                <Typography variant="h6" className="text-center md:w-full mb-48">ĐĂNG NHẬP ADMIN</Typography>
                                <AdminTLoginTab/>
...
export default withStyles(styles, {withTheme: true})(withRouter(AdminLogin));
