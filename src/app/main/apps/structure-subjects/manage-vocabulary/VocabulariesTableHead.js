...
class VocabulariesTableHead extends React.Component {
    state = {
        ...
        return (
            <TableHead>
                <TableRow className="h-54">
                    ...
                    {TABLE_HEADERS_VOCABULARY.map(row => {
                        return (
                            <TableCell
                                key={row.id}
                                align={row.align}
...
export default withStyles(styles, {withTheme: true})(VocabulariesTableHead);
