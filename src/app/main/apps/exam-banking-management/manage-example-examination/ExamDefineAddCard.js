...
class ExamDefineAddCard extends Component {
  ...
  onSubmit = (ev) => {
    ev.preventDefault();
    const {point, questionType, questionsPack, topicPointList} = this.state.form;
    this.props.addNewExamDefine(new ExamDefineDetailModel({point, questionType, questionsPack, topicPointList}));
...
export default connect(mapStateToProps,)(ExamDefineAddCard);
