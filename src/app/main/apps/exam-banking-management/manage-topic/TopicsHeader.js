...
import {helpers, RIGHT_ID_TOPIC, RIGHT_ACT_CREATE} from "../../../../../common/Constants"
import {TABLE_HEADERS_TOPIC} from "../../../../../common/Constants"

const fields = TABLE_HEADERS_TOPIC.slice(0,-1)
        ...
        <div className="flex flex-1 w-full items-center justify-between">
            ...
            <div className="header-right-top-desc flex items-center">
                ...
                <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                    <Typography className="hidden sm:flex" variant="h6">Danh sách chuyên đề</Typography>
                </FuseAnimate>
            </div>
            ...
            <div style={{display:helpers.getDisplay(user.role.rights, RIGHT_ID_TOPIC, RIGHT_ACT_CREATE)}}>
                <FuseAnimate animation="transition.slideRightIn" delay={300}>
                    <Button component={Link} to="/topic/new" className="whitespace-no-wrap" variant="contained">
                        <span className="hidden sm:flex">Tạo Chuyên Đề</span>
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        setField: Actions.setTopicField,
        setSearchText: Actions.setTopicsSearchText
    }, dispatch);
}

function mapStateToProps({topicsApp, fuse, auth})
{
    return {
