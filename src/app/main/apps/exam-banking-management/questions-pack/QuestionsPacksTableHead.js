...
class QuestionsPacksTableHead extends React.Component {
    state = {
        selectedQuestionsPacksMenu: null
    };
    ...
    openSelectedProductsMenu = (event) => {
        this.setState({selectedQuestionsPacksMenu: event.currentTarget});
    };

    closeSelectedProductsMenu = () => {
        this.setState({selectedQuestionsPacksMenu: null});
    };
        ...
        return (
            <TableHead>
                <TableRow className="h-54">
                    ...
                    {TABLE_HEADERS_QUESTIONPACK.map(row => {
                        return (
                            <TableCell
                                key={row.id}
                                align={row.align}
...
export default withStyles(styles, {withTheme: true})(QuestionsPacksTableHead);
