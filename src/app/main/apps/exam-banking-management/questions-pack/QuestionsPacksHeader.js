...
import QuestionsModalResult from "./QuestionsModalResult";
...
class QuestionsPacksHeader extends Component {
                ...
                <div className="flex flex-1 w-full items-center justify-between">
                    ...
                    <div style={{display:helpers.getDisplay(user.role.rights, RIGHT_ID_QUESTIONPACK, RIGHT_ACT_CREATE)}}>
                        <FuseAnimate animation="transition.slideRightIn" delay={300}>
                            <Button component={Link} to="/questionsPack/new" className="whitespace-no-wrap" variant="contained">
                                <span className="hidden sm:flex">Thêm mới gói câu hỏi</span>
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        setField: Actions.setQuestionsPackField,
        setSearchText: Actions.setQuestionsPackSearchText
    }, dispatch);
}

function mapStateToProps({questionsPackApp, fuse, auth})
{
    return {
...
export default connect(mapStateToProps, mapDispatchToProps)(QuestionsPacksHeader);
