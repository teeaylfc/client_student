...
import {TABLE_HEADERS_CLASS} from "../../../../../common/Constants";

const fields = TABLE_HEADERS_CLASS.slice(0,-2)
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        setField: Actions.setClassField,
...
export default connect(mapStateToProps, mapDispatchToProps)(ClassesHeader);
