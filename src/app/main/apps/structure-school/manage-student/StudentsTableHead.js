...
class StudentsTableHead extends React.Component {
    state = {
    ...
    render()
    {
        ...
        const {selectedStudentsMenu} = this.state;
                        ...
                        {numSelected > 0 && (
                            <div className={classNames("flex items-center justify-center absolute w-64 pin-t pin-l ml-68 h-64 z-10", classes.actionsButtonWrapper)}>
                                <IconButton
                                    ...
                                    aria-haspopup="true"
                                    onClick={this.openSelectedStudentsMenu}
                                >
                                ...
                                <Menu
                                    ...
                                    onClose={this.closeSelectedStudentsMenu}
                                >
                                    <MenuList>
                                        <MenuItem
                                            onClick={() => {
                                                this.closeSelectedStudentsMenu();
                                            }}
                                        >
...
export default withStyles(styles, {withTheme: true})(StudentsTableHead);
